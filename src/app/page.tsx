        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <BlurFade delay={BLUR_FADE_DELAY}>
            <div className="flex justify-center">
              <div className="inline-flex items-center rounded-full bg-green-100 text-green-800 px-4 py-2 text-sm font-medium dark:bg-green-900 dark:text-green-100">
                <span className="flex h-2 w-2 mr-2">
                  <span className="animate-ping absolute inline-flex h-2 w-2 rounded-full bg-green-400 opacity-75"></span>
                  <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
                </span>
                Open to work as Business Analyst, Product Analyst and Project Manager
              </div>
            </div>
          </BlurFade>
      ...
      <section id="certifications">
        <div className="flex min-h-0 flex-col gap-y-3">
          ...
          {DATA.achievements.filter(achievement => 
            achievement.title !== "Excel Certificate"
          ).map((achievement, id) => (
            <BlurFade
